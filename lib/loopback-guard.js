...
/**
 * Host/Origin gating for Eddie's loopback HTTP server. DNS rebinding can
 * point an attacker-controlled hostname at 127.0.0.1, so every request
 * must present a Host header from this allowlist before the server does
 * any work.
 */
