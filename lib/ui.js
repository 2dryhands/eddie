  ...
  <aside class="panel">
    ...
    <div class="composer">
      ...
      <div class="actions">
        ...
        <button id="changes" class="act changes-act" type="button" data-i18n-title="requestChangesHint">🔧 <span data-i18n="requestChanges">Revise</span><span class="n"></span></button>
        <button id="approve" class="act approve-act" type="button" data-i18n-title="approveHint">✅ <span data-i18n="approve">Done</span><span class="n"></span></button>
      </div>
