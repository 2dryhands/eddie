...
(() => {
  ...
  function renderChat(entries) {
    ...
    if (!entries.length) {
      ...
      empty.textContent = [t('onboarding1'), t('onboarding2'), t('onboarding3')].join(' ');
...
<div class="layout">
  ...
  <aside class="panel">
    <h2>Plan verdict</h2>
    <div class="verdict">
      <button id="approve" class="approve" type="button" data-i18n="approve" data-i18n-title="approveHint">Approve</button>
      <button id="changes" class="changes" type="button" data-i18n="requestChanges" data-i18n-title="requestChangesHint">Request changes</button>
    </div>
    <h2 data-i18n="conversationHeader">Conversation</h2>
    <div id="chatLog" class="chat"></div>
    <div id="queue" class="queue"></div>
    <div class="composer">
      <textarea id="chatInput" data-i18n-ph="composerPlaceholder" placeholder="Message the agent&#10;Enter to send &middot; Shift+Enter for a new line"></textarea>
      <div class="row">
        <button id="send" class="send" type="button" data-i18n="send" data-i18n-title="sendHint">Send</button>
      </div>
      <div id="sendStatus" class="status"></div>
      <div class="hint" data-i18n="queuedHint">Notes queue up here until you send them together.</div>
    </div>
  </aside>
</div>
